                ...
                [
                    html.Div(
                        [
                            ...
                            html.H4(
                                "Gegen Ende dieses Jahres wird ein Punkt erreicht, an dem selbst bei einer vollständigen Einstellung aller CO₂-Emissionen das Ziel, die globale Erwärmung auf 1,5 Grad Celsius zu begrenzen, mit einer Wahrscheinlichkeit  von mehr als 50% unerreichbar sein wird. Diese Entwicklung unterstreicht die Unzulänglichkeit bisheriger Klimapolitik. Es ist absehbar, dass mit einer Wahrscheinlichkeit von über 50% auch das langfristige Ziel einer maximalen Erwärmung um 2 Grad Celsius verfehlt wird, sofern die bisherigen Klimaschutzpläne nicht signifikant ambitionierter gestaltet werden."
                            ),
                        ],
                        style={
                            "text-align": "center",
